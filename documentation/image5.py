...
FONT_PATHS = [
    ...
    "fonts/variable/AlternateGlyphsAvar1[opsz,wdth,wght].ttf",
    "fonts/variable/AlternateGlyphsAvar2[opsz,wdth,wght].ttf",
    "fonts/variable/AlternateGlyphsFencesAvar2[opsz,wdth,wght].ttf",
