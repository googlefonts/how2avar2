...
description: Special thanks to everyone who helped contribute to this project.
---
...
By spearheading avar2, Google Fonts achieves its motto of “Beautiful text, Google scale”.

avar2 offers improvements to each of the core value propostions of variable fonts: Compression, Expression, Automation, Internationalization, and Animation.
