---
title: Warping – Design Space Distortion
description: Axis interdependence means better interpolation that accurately matches the type designer’s intentions, and removes duplicated axes.
---
