...
If you are hoping to create animations with axes like Flow similar to the Underware font foundry, you may have to write the scripts yourself. None of Underware’s implementations are open-source. However there is a GlyphsApp plug-in.

More technical and in-depth explanations are available from Ben Wager[^fn7] and Peter Constable[^fn8], and there's a discussion on TypeDrawers[^fn9].
...
[^fn7]: https://bungeman.github.io/hoi.html
[^fn8]: https://github.com/PeterConstable/OT_Drafts/blob/master/NLI/UnderstandingNLI.md
[^fn9]: https://typedrawers.com/discussion/3540/non-linear-or-higher-order-interpolation-hoi
[^fn10]: https://pkolchanov.ru/nla/
