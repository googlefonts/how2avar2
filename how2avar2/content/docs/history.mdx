...
import phototypesetting from "../../public/static/images/phototype-combined-screenshot-optimized.jpg";
import ikarus from "../../public/static/images/ikarus-combined-screenshot.jpg";
import scheinerPantograph from "../../public/static/images/scheiner-pantograph-edited-cropped.png";
import bentonPantograph from "../../public/static/images/BEN-154-SIL-copy.jpg";
...
<figure>
  ...
  <figcaption>
    This
    [leaf](https://en.wikipedia.org/wiki/File:English_-_Rochester_Bible_-_Walters_W18_-_Reverse_Detail.jpg)
    from the Rochester Bible circa 1135AD is a beautiful example of calligraphy
    in multiple styles, colors, sizes, and layouts.
  </figcaption>
</figure>
...
<figure>
  <Image
    src={scheinerPantograph}
    alt="The first recorded diagram of a pantograph"
  />
  <figcaption>
    A
    [diagram](https://commons.wikimedia.org/wiki/File:Pantograph_by_Christoph_Scheiner.jpg)
    of Christopher Scheiner’s pantograph.
  </figcaption>
</figure>
...
<figure>
  <Image
    src={bentonPantograph}
    alt="An image of the large Benton Pantograph model"
  />
  <figcaption>
...
<figure>
  ...
  />
  <figcaption>
    Photos of Akzidenz-Grotesk diatype disc (left) and diatonic plate (right)
    used for phototypesetting in the 1980s,
