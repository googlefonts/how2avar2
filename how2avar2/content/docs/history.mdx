...
Before the invention of metal type, calligraphy reigned over the written word. While type design requires creating consistent and predefined forms, calligraphy allows for adaptability in the overall layout and design. With the help of typographers and layout designers, type designers can easily and consistently create impressive work. Though even today, OpenType features cannot fully duplicate the art and flexibility of calligraphy and lettering styles.
...
For centuries[^fn5], type designers worked with punch cutters to create metal type. Gutenberg’s first metal type resembled calligraphy and was familiar to readers. Because the craftsmen created each metal letter in a specific size, weight, and style, they could fine-tune each letter for its particular use. For example, some punch cutters customized the metal type by shortening descenders and changing the x-height relative to the capital letters. However, some punch cutters did not significantly alter the metal type, and the only difference was the ink spread from printing.
