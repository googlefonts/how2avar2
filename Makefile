...
build: build.stamp
	...
	fonttools feaLib "./sources/variable-font-substitutions.fea" "./fonts/variable/AlternateGlyphs[opsz,wdth,wght].ttf" -o "./fonts/variable/AlternateGlyphs[opsz,wdth,wght].ttf"

	# fix opsz axis
	./scripts/fix-axis-bounds.py --inplace --axis opsz --min 6 --max 144 "fonts/variable/TestFont[opsz,wdth,wght].ttf"
	./scripts/fix-axis-bounds.py --inplace --axis opsz --min 6 --max 144 "fonts/variable/AlternateGlyphs[opsz,wdth,wght].ttf"
	./scripts/fix-axis-bounds.py --inplace --axis ZROT --min 0 --max 90 "fonts/variable/QuadraticRotation[AAAA,BBBB,ZROT].ttf"
	...
	fonttools varLib.avar.build -o "./fonts/variable/AlternateGlyphsAvar1[opsz,wdth,wght].ttf" "./fonts/variable/AlternateGlyphs[opsz,wdth,wght].ttf" "./sources/avar1.designspace"
	./scripts/rename-fonts.py --inplace --suffix " Avar1" "./fonts/variable/AlternateGlyphsAvar1[opsz,wdth,wght].ttf"
	...
	fonttools varLib.avar.build -o "./fonts/variable/AlternateGlyphsAvar2[opsz,wdth,wght].ttf" "./fonts/variable/AlternateGlyphs[opsz,wdth,wght].ttf" "./sources/avar2.designspace"
	./scripts/rename-fonts.py --inplace --suffix " Avar2" "./fonts/variable/AlternateGlyphsAvar2[opsz,wdth,wght].ttf"
	...
	fonttools varLib.avar.build -o "./fonts/variable/AlternateGlyphsFencesAvar2[opsz,wdth,wght].ttf" "./fonts/variable/AlternateGlyphs[opsz,wdth,wght].ttf" "./sources/avar2Fences.designspace"
	./scripts/rename-fonts.py --inplace --suffix " Fences Avar2" "./fonts/variable/AlternateGlyphsFencesAvar2[opsz,wdth,wght].ttf"
	...
	fonttools varLib.avar.build -o "./fonts/variable/AlternateGlyphsOpticalSizeAvar2[opsz,wdth,wght].ttf" "./fonts/variable/AlternateGlyphs[opsz,wdth,wght].ttf" "./sources/avar2OpticalSize.designspace"
	./scripts/rename-fonts.py --inplace --suffix " Optical Size Avar2" "./fonts/variable/AlternateGlyphsOpticalSizeAvar2[opsz,wdth,wght].ttf"

	# create Avar2 demo with quadratic rotation
	fonttools varLib.avar.build -o "./fonts/variable/QuadraticRotation[AAAA,BBBB,ZROT].ttf" "./fonts/variable/QuadraticRotation[AAAA,BBBB,ZROT].ttf" "./sources/avar2QuadraticRotation.designspace"

	# decompile fonts for testing
	# rm -rf "ttx"
	# mkdir "ttx"
	# ttx -d "ttx" "fonts/variable/TestFont[opsz,wdth,wght].ttf"
